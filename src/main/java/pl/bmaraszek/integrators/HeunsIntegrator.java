 ...
 * 
 */
public class HeunsIntegrator implements Integrator {
	...
	public void integrate(Vertex state, double dt) {
		...
		final Vector2D dxdt = a.getVelocity().add(b.getVelocity());
		final Vector2D dvdt = a.getAcceleration().add(b.getAcceleration());
